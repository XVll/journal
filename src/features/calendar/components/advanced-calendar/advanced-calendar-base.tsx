...
export type AdvancedCalendarBaseProps = React.ComponentProps<typeof DayPicker>

function AdvancedCalendarBase({
  className,
  classNames,
  showOutsideDays = true,
  ...props
}: AdvancedCalendarBaseProps) {
  return (
      <DayPicker
...
AdvancedCalendarBase.displayName = "AdvancedCalendarBase"

export { AdvancedCalendarBase }